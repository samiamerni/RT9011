...
def compare(codedrink,codemonnaie,codeGetDrink):
    if codedrink == codemonnaie and codemonnaie == codeGetDrink :
        print("la boisson a été validé , les pieces ont été inseré et la boisson peut etre récupérer")
        return True
    elif codedrink == codemonnaie and codemonnaie != codeGetDrink :
        print("la boisson a été validé , les pieces ont été inseré et  la boisson ne peut pas etre récupérer")
        return False
    elif codedrink != codemonnaie and codemonnaie != codeGetDrink:
        print("la boisson n'a été validé , les pieces ont été inseré et la boisson ne peut pas etre récupérer")
        return False
...
if __name__ == "__main__":
    ...
    getdrink =recerivefrom(UDPServerSocket,msgsend,idreq_4)
    codeGetDrink=  checkGetDrink(getdrink,msgsend,idreq_4)
    ## comparer
    compare(codedrink,codeimonnaie,codeGetDrink)
    logfile()
