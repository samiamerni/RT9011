...
def compare(codedrink,codemonnaie,coderendumonnaie):
    if codedrink == codemonnaie and codemonnaie == coderendumonnaie :
        print("la boisson a été validé , les pieces ont été inseré et le rendu monnaie est fait")
        return True
    elif codedrink == codemonnaie and codemonnaie != coderendumonnaie :
        print("la boisson a été validé et les pieces ont été inseré et le rendu monnaie n'a pas été fait")
        return False
    elif codedrink != codemonnaie and codemonnaie != coderendumonnaie:
        print("la boisson n'a été validé et les pieces ont été inseré et le rendu monnaie n'a pas été fait")
        return False
...
if __name__ == "__main__":
    ...
    listedata_2 = []
    ## inserer monnaie
    msgsend = sendto(UDPServerSocket,bytes.fromhex("2401"))
    ...
    getmonnaie =recerivefrom(UDPServerSocket,msgsend,idreq_4)
    codeGetmonnaie=  checkGetMonnaie(getmonnaie,msgsend,idreq_4)
    ## comparer
    compare(codedrink,codeimonnaie,codeGetmonnaie)
    logfile()
