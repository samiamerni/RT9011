...
if __name__ == "__main__":
    ...
    price1=decodeprice(validatedrink,stringjson,msgsend,idreq_3)
    logfile()
    listedata_1 = [] 
    ## inserer monnaie
    msgsend = sendto(UDPServerSocket,bytes.fromhex("2403"))
    ...
    stringjson = openconfigfile()
    prixapres= decodeprice(validatedrink,stringjson,msgsend,idreq_5)
    logfile()
    #### compare
    compare(price1,prixapres)
