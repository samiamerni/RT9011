...
if __name__ == "__main__":
    ...
    ## selectionner une autre boisson apres la validation de la boisson
    msgsend = sendto(UDPServerSocket,second)
    bytesAddressPair =recerivefrom(UDPServerSocket,msgsend,idreq_4)
    selectdrink2 = checkIfCanSelectDrink(bytesAddressPair,msgsend,idreq_3)
    logfile()  
