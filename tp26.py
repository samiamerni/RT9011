...
if __name__ == "__main__":
    ...
    goblets_avant= recupererNbrSucre(infos,msgsend,idreq_1,listedata_2)
    ...
    goblets_apres= recupererNbrSucre(infos,msgsend,idreq_8,listedata_9)
